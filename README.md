...
🔭 Currently working as an **Embedded Systems Intern**, gaining hands-on experience in microcontrollers, hardware interfacing, and real-world product development.

👯 Open to collaborate on **Robotics, ROS 2, Autonomous Systems, Simulation-based Robotics, and Embedded AI projects**.

🌱 Learning **ROS 2 (Humble), Navigation Stack, SLAM, Advanced PCB Design, NVIDIA Isaac Sim, and Isaac Lab**.

💬 Ask me about **ESP32, Microcontrollers, Robotics, ROS 2, Isaac Sim, PCB Design, Sensors, and Hardware-Software Integration**.
...
[![](https://visitcount.itsvg.in/api?id=siddarthakvn&icon=0&color=0)](https://visitcount.itsvg.in)
